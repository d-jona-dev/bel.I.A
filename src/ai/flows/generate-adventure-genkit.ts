...
2.  **Describe Scene for Image (in English):** 
    ...
    - For \`sceneDescriptionForImage.cameraAngle\`, suggest a CREATIVE and DYNAMIC camera angle to make the scene more visually interesting. Examples: "dynamic low-angle shot", "dramatic close-up on Rina's face", "aerial view of the classroom", "over-the-shoulder shot from Kentaro's perspective", "Dutch angle showing the tension". Leave empty if no specific angle comes to mind.
