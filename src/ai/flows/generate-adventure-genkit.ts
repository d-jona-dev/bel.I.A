...
import type { Character, PlayerSkill, MapPointOfInterest, FamiliarPassiveBonus, AiConfig } from '@/types';
import { LootedItemSchema, NewFamiliarSchema } from '@/types';
...
export async function generateAdventureWithGenkit(input: GenerateAdventureInput): Promise<GenerateAdventureFlowOutput> {
