               ...
               <nav className="space-y-2">
                 ...
                 <TooltipProvider>
                     <Tooltip>
                       <TooltipTrigger asChild>
                          <Link href="/avatars">
                            <Button variant="secondary" className="w-full justify-start group-data-[collapsible=icon]:justify-center" aria-label={lang.playerAvatarsTooltip}>
       ...
       <SidebarInset className="flex flex-col h-screen">
         <header className="flex items-center justify-between p-4 border-b bg-background sticky top-0 z-10">
            <div className="flex items-center space-x-2">
              <SidebarTrigger />
              <span className="font-semibold">{lang.playerAvatarsTooltip}</span>
            </div>
         </header>
